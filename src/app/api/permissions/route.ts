...
const MOCK_PERMISSIONS = [
  ...
  { code: 'ventas.create_quote', name: 'Crear Cotización', module: 'ventas', description: 'Permite crear cotizaciones' },
  { code: 'ventas.create_invoice', name: 'Crear Factura', module: 'ventas', description: 'Permite crear facturas' },
  { code: 'ventas.create_sales_order', name: 'Crear Orden de Venta', module: 'ventas', description: 'Permite crear órdenes de venta' },
